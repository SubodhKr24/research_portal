...
<div class="st-galleria" style="width: <?php echo $params->get('galleria_width');?>; height: <?php echo $params->get('galleria_height');?>;" id="<?php echo $id; ?>">
			...
			<img 
				...
				<?php if ((int)$params->get('introtext', 1) > 0 && $item->introtext != ''): ?>
					<?php if($params->get('title_link',1)):?>
			        	data-title="<a href='<?php echo $item->link;?>'><?php echo htmlspecialchars($item->title); ?> </a>"
			        <?php else: ?>
