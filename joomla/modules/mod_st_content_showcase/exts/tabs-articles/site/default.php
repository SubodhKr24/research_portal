	...
	$html .= '<div class="tab-content">';
		...
		foreach ($result['hits'] as $item) 
		{
			$html .= '<div class="outter"><div class="row-fluid">';
				...
				if (isset($item->image_intro) and !empty($item->image_intro)) {
					switch($params->get('image_link')){
					case 0:
						$html .= '<img src="'.$item->image_intro.'"/>';
						break; 
					case 1:
						$html .= '<a href="'.$item->link.'"><img src="'.$item->image_intro.'"/></a>';
						break; 
					case 2:
						$html .= '<a href="'.$item->image_large.'"><img src="'.$item->image_intro.'"/></a>';
					};
				}
				$html .= '</div>';
				...
				$html .= '<p class="date">' . JHTML::_('date', $item->created, JText::_('DATE_FORMAT_LC2')) . '</p>';
				$html .= '</div>';
