			...
			<div class="inner">
				...
				?>
					<?php switch($params->get('image_link')){
						...
						<?php break; case 1:?>
						<a <?php echo ($params->get('wall_modal', 1)) ? ' class="modal" rel="{handler: \'image\'}" ' : ''; ?>  href="<?php echo $item->link	; ?>" title="<?php echo htmlspecialchars($item->title); ?>">
						<div class="media">
							<img src="<?php echo htmlspecialchars($item->image_intro); ?>"  alt="<?php echo htmlspecialchars($item->title); ?>"/>
						</div>
						</a>
				...
				<div class="info <?php echo $classImage; ?>">
					...
					<?php if($params->get('wall_category',1) && isset($item->category) && $item->category != ''): ?>
						<div class="category">
